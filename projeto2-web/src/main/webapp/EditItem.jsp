...
<div class="container">
    ...
    <div class="row">
        <!-- left column -->
        <form action="app/EditItem" method="post" enctype="multipart/form-data">
            <div class="col-md-3">
            ...
            <div class="col-md-9 personal-info">
                ...
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input name="name" class="form-control" type="text" value="<%= item.getName()%>">
                        </div>
                        <label class="col-lg-3 control-label">Price:</label>
                        <div class="col-lg-8">
                            <input name="price" class="form-control" type="text" value="<%= item.getPrice()%>">
                        </div>
                    </div>
